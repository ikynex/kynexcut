package org.ikynex.kynexcut.customviews
...
class DraggableImageOverlayView @JvmOverloads constructor(
    ...
    // ── Public callbacks ──────────────────────────────────────────────────────
    var onImageCommitted: ((uri: Uri, relativeX: Float, relativeY: Float, relativeWidth: Float, relativeHeight: Float, rotationAngle: Float, opacity: Float, isMirrored: Boolean, maskConfig: org.ikynex.kynexcut.models.EditOperation.MaskConfig) -> Unit)? = null
    var onPositionChanged: ((relativeX: Float, relativeY: Float) -> Unit)? = null
    var onMaskChanged: ((org.ikynex.kynexcut.models.EditOperation.MaskConfig) -> Unit)? = null
    ...
    var maskConfig = org.ikynex.kynexcut.models.EditOperation.MaskConfig()
    ...
    fun activate(uri: Uri, aspect: Float = 1.0f) {
        ...
        maskConfig = org.ikynex.kynexcut.models.EditOperation.MaskConfig()
        post {
            updateImageViewSizeAndPosition()
        }
    }

    fun activateForEdit(op: org.ikynex.kynexcut.models.EditOperation.AddImageOverlay) {
        isEditingActive = true
    ...
    override fun dispatchDraw(canvas: Canvas) {
        val hasMask = maskConfig.shape != org.ikynex.kynexcut.models.EditOperation.MaskShape.NONE
        if (hasMask && isEditingActive && imageUri != null) {
            ...
            when (maskConfig.shape) {
                org.ikynex.kynexcut.models.EditOperation.MaskShape.RECTANGLE -> {
                    path.addRect(cx - mw/2, cy - mh/2, cx + mw/2, cy + mh/2, android.graphics.Path.Direction.CW)
                }
                org.ikynex.kynexcut.models.EditOperation.MaskShape.ELLIPSE -> {
                    path.addOval(cx - mw/2, cy - mh/2, cx + mw/2, cy + mh/2, android.graphics.Path.Direction.CW)
                }
                org.ikynex.kynexcut.models.EditOperation.MaskShape.SPLIT -> {
                ...
                org.ikynex.kynexcut.models.EditOperation.MaskShape.SHUTTER -> {
                ...
                org.ikynex.kynexcut.models.EditOperation.MaskShape.HEART -> {
                    createHeartPath(path, cx, cy, mw, mh)
                }
                org.ikynex.kynexcut.models.EditOperation.MaskShape.STAR -> {
